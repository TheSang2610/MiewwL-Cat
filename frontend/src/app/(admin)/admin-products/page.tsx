...
export default function AdminProductsPage() {
  ...
  const filtered = useMemo(
    ...
    [products, search, category, status, stock, group]
  );
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-brand-deep">Quản lý Sản phẩm</h1>
          <p className="text-sm text-brand-deep/50">Danh sách toàn bộ sản phẩm trong hệ thống</p>
        </div>
        <Link
